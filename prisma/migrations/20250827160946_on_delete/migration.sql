...
INSERT INTO "new_PickupMethods" ("description", "id", "locationId", "name", "sessionId", "zepietId") SELECT "description", "id", "locationId", "name", "sessionId", "zepietId" FROM "PickupMethods";
...
CREATE TABLE "new_ShippingMethod" (
    ...
    "description" TEXT,
    "sessionId" TEXT NOT NULL,
    CONSTRAINT "ShippingMethod_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "Session" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
